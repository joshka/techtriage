...
pub struct InventoryExtension {
    ...
    pub(super) device_manufacturers: Vec<DeviceManufacturer>,
    pub(super) device_classifications: Vec<DeviceClassification>,
...
impl ExtensionManager {
    ...
    pub(super) fn new(ctx: &Context) -> anyhow::Result<Self> {
    ...
    pub(super) async fn load_extensions(self, db: &Database) -> anyhow::Result<Vec<LoadConflict>> {
